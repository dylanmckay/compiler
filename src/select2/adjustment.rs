...
/// original pattern in order to possibly match.
///
...
pub struct AdjustmentApplication<V: PatternValue>
{
    ...
    pub viral_adjustments: Vec<Adjustment<V>>,
}
...
impl<V: PatternValue> AdjustmentApplication<V>
{
    ...
    pub fn merge(mut self, other: Self) -> Self {
        ...
        self.viral_adjustments.extend(other.viral_adjustments);
        self
    }
}
        ...
        match *self {
            ...
            Adjustment::CoerceValue { ref from, ref to } => {
                ...
                AdjustmentApplication {
                    preceding_nodes: Vec::new(),
                    adjusted_node: adjusted_node,
                    viral_adjustments: vec![Adjustment::CoerceValue {
                        from: from.clone(),
                        to: to.clone(),
                    }],
                }
